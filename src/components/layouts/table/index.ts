...
const addStyle = (
  ...
  if (allHaveBold && addProperty === "font-bold") {
    tableCoordinates.forEach((cell) => {
      const classNames =
        (hotInstance.getCellMeta(cell.row, cell.col).className as string) || "";
    ...
    tableCoordinates.forEach((cell) => {
      if (property == "className") {
        const existingClassNames =
          (hotInstance.getCellMeta(cell.row, cell.col)[property] as string) ||
          "";
        const classArray = new Set<string>(existingClassNames.split(" "));
        const newClassArray = Array.from(classArray);
        const uniqueClassNames = newClassArray.join(" ");
    ...
    return [
      ...
      },
      {
        ...
        extra: {
          ...
          props: {
            handler: this.createHandler((event, hotInstance, value) => {
      ...
      },
      {
        ...
        extra: {
          ...
          props: {
            handler: this.createHandler((event, hotInstance, value) => {
              addStyle(event, value, "backgroundColor", hotInstance);
            }),
          },
        },
      },
            ...
            extra: {
              ...
              props: {
                ...
                handler: this.createHandler((event, hotInstance, value) => {
                  ...
                  hotInstance.alter("insert_row_above", selectedRow, value);
                }),
              },
            },
          },
            ...
            extra: {
              ...
              props: {
                ...
                handler: this.createHandler((event, hotInstance, value) => {
                  ...
                  hotInstance.alter("insert_row_below", selectedRow, value);
                }),
              },
            },
          },
            ...
            extra: {
              ...
              props: {
                ...
                handler: this.createHandler((event, hotInstance, value) => {
                  ...
                  hotInstance.alter("insert_col_start", selectedCol, value);
                }),
              },
            },
          },
            ...
            extra: {
              ...
              props: {
                ...
                handler: this.createHandler((event, hotInstance, value) => {
                  ...
                  hotInstance.alter("insert_col_end", selectedCol, value);
                }),
              },
            },
          },
        ...
        options: [
          {
            ...
            icon: AlignLeft,
            handler: this.createHandler((event, hotInstance) => {
              addStyle(event, "htLeft htMiddle", "className", hotInstance);
            }),
          },
          {
            label: "居中对齐",
            icon: AlignCenter,
            handler: this.createHandler((event, hotInstance) => {
              addStyle(event, "htCenter htMiddle", "className", hotInstance);
            }),
          },
          {
            label: "右对齐",
            icon: AlignRight,
            handler: this.createHandler((event, hotInstance) => {
              addStyle(event, "htRight htMiddle", "className", hotInstance);
            }),
          },
        ],
      },
        ...
        options: [
          {
            ...
            handler: this.createHandler((event, hotInstance) => {
              ...
              hotInstance.setDataAtCell(endRow, endColumn, `=SUM(A1,A1)`);
            }),
          },
          {
            label: "AVERAGE 求平均",
            ...
            handler: this.createHandler((event, hotInstance) => {
              const [_, __, endRow, endColumn] = event;
              hotInstance.setDataAtCell(endRow, endColumn, `=AVERAGE(A1,A1)`);
            }),
          },
          {
            label: "IF 条件判断",
          ...
          },
          {
            ...
            handler: this.createHandler((event, hotInstance) => {
              const [_, __, endRow, endColumn] = event;
              hotInstance.setDataAtCell(endRow, endColumn, `=MOD(数值,除数)`);
            }),
          },
        ],
      },
