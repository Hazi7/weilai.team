    ...
    <div style="display: flex;">
        <div class="contanier">
            ...
            <div class="navBox">
                <ul>
                    <li>
                        <router-link active-class="active" to="/personalCenter/userInfo/myPosts">
                            我的帖子
                        </router-link>
                    </li>
                    <li>
                        <router-link active-class="active" to="/personalCenter/userInfo/myGrades">
                            我的成绩
                        </router-link>
                    </li>
                    <li>
                        <router-link active-class="active" to="/personalCenter/userInfo/mySchedule">
                            我的课表
                        </router-link>
                    </li>
                </ul>
