        ...
        <div class="header">
            ...
            <div class="moreInfoBox">
                ...
                <div class="moreInfo" v-show="isShow">
                    ...
                    <p>
                        <Icon style="display: inline-block;font-size: 18px;" icon="ri:group-line" /> 组别: <span>六组</span>
                    </p>
                    <p>
                    ...
                    <p>
                        <Icon style="display: inline-block;font-size: 18px;" icon="ic:outline-email" /> 班级:
                        <span>计科231</span>
                    </p>
                    <p>
                        <Icon style="display: inline-block;font-size: 18px;" icon="ic:outline-email" /> 电话:
                        <span>12345678910</span>
                    </p>
                    <p>
                        <Icon style="display: inline-block;font-size: 18px;" icon="ic:outline-email" /> QQ:
                        <span>2020202020</span>
                    </p>
                    <p>
                        <Icon style="display: inline-block;font-size: 18px;" icon="ic:outline-email" /> 毕业去向:
                        <span>华为</span>
                    </p>
                </div>
            </div>
            ...
            <div class="lastLoginTime">
                ...
                <p>
                    <Icon style="display: inline-block;" icon="mdi:calendar-outline" />上次登录时间：<span>2020-01-01</span>
                </p>
